...
<html>
	...
	<body>
		...
		<div id="create-transaction" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:transactionInstance, action:'submit']" >
				<fieldset class="form">
					<g:render template="form"/>
				</fieldset>
				<fieldset class="buttons">
					<g:submitButton name="submitpayment" class="save" value="${message(code: 'default.button.pay.label', default: 'Submit payment')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
