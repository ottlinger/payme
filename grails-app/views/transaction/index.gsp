		...
		<div id="list-transaction" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="transaction.owner.label" default="Owner" /></th>
					
						<th><g:message code="transaction.partner.label" default="Partner" /></th>
				...
				<g:each in="${transactionInstanceList}" status="i" var="transactionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${transactionInstance.id}">${fieldValue(bean: transactionInstance, field: "owner")}</g:link></td>
